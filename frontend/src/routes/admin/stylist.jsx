...
export const Route = createFileRoute("/admin/stylist")({
    head: () => ({ meta: [{ title: "Stylist — Admin" }] }),
    component: AdminWip,
});
function AdminWip() {
    return (<div>
            <section className="bg-onyx pt-20 pb-16 text-background">
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <h1 className="font-display mt-4 text-4xl font-semibold md:text-5xl">Stylist</h1>
                </div>
            </section>
            ...
            <section className="mx-auto max-w-5xl px-6 py-32 text-center">
                <div className="rounded-2xl bg-card p-12 shadow-sm inline-block">
                    ...
                    <p className="mt-4 max-w-md text-muted-foreground text-lg">
                        The Stylist panel is currently under development. Check back later!
                    </p>
                </div>
            </section>
        </div>);
